...
public:
	...
	*/
	void print_result(std::ofstream** sout, data_rep_t repres);
	//! Print the data of all bodies in text format
	/*   
		\param sout print the data to this stream
	*/
	void print_result_ascii(std::ofstream& sout);
	//! Print the data of all bodies in binary format
	/*!
		\param sout print the data to this stream
	*/
	void print_result_binary(std::ofstream& sout);
	...
	/*!
		...
		\param repres indicates the data representation of the file, i.e. text or binary
	*/
	void print_integral_data(std::ofstream** sout, data_rep_t repres);
	//! Print the energy integral in text format
	/*   
		\param sout print the data to this stream
	*/
	void print_integral_data_ascii(std::ofstream& sout);
	//! Print the energy integral in binary format
	/*!
		\param sout print the data to this stream
	*/
	void print_integral_data_binary(std::ofstream& sout);
